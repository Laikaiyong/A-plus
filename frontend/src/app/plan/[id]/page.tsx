      ...
      setTimeout(() => {
        const contents = {
          text: `# ${studyPlan.title} - Text Summary\n\n## Key Concepts\n${
            ...
            studyPlan.sessions[0].topics[0]
          }\n2. Apply ${
            studyPlan.sessions[1].topics[0]
          } in practical scenarios\n3. Compare and contrast ${studyPlan.sessions[2].topics.join(
            " and "
          )}`,
          ...
          `### Part ${i + 1}: ${
            ...
            studyPlan.sessions[1].topics[0]
          } and ${studyPlan.sessions[2].topics[0]} build upon it.`,

          infographic: `# ${studyPlan.title} - Visual Guide\n\n## Infographic\n![Sample infographic for ${
            studyPlan.title
          }](/sample_infographic.jpeg)\n\n![Sample infographic 1](/sample_infographic1.jpeg)\n`,
        ...
        <motion.div
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-4">
              ...
              {contentFormats.find((f) => f.id === activeFormat)?.title} Format
            </h2>
            ...
            {generatingContent ? (
              ...
              <>
                {aiContent && activeFormat === "audio" && (
                  <motion.div
                    className="mt-4"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5 }}>
                    <div className="flex flex-col sm:flex-row items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <button
                        onClick={() =>
                          aiContent && generateAudioFromText(aiContent)
                        }
                ...
                {aiContent && activeFormat === "video" && (
                  <motion.div
                    ...
                    <div className="prose dark:prose-invert prose-orange max-w-none">
                      <div
                        dangerouslySetInnerHTML={{
                          __html: aiContent ? marked(aiContent) : "",
                        }}
                      />
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      ...
                      <VideoGenerator
                        prompt={`Create a video about ${studyPlan.title}: ${
                          studyPlan.content.overview.split(".")[0]
                        }`}
                      />
                    </div>
